...
extern touchgfx::GeneratedFont& getFont_verdanaz_13_4bpp();
extern touchgfx::GeneratedFont& getFont_verdana_20_4bpp();
extern touchgfx::GeneratedFont& getFont_verdanaz_11_4bpp();
extern touchgfx::GeneratedFont& getFont_verdanaz_20_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_verdanaz_13_4bpp()),
    &(getFont_verdana_20_4bpp()),
    &(getFont_verdanaz_11_4bpp()),
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_verdanaz_13_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_verdana_20_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_verdanaz_11_4bpp());
        break;
    case 3:
